...
<NavGrid>
  ...
  />
  <NavCard
    href="/ko-kr/appendix/8-artificial-intelligence/image-generation"
    title="AI 이미지 생성 원리"
...
<NavGrid>
  <NavCard
    href="/ko-kr/appendix/4-server-and-backend/api-intro"
    title="API 입문"
  ...
  />
  <NavCard
    href="/ko-kr/appendix/1-computer-fundamentals/computer-networks"
    title="컴퓨터 네트워크"
